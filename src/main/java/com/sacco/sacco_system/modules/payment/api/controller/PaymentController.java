...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<Object>> payLoanFee(
        ...
        Map<String, Object> response = paymentService.initiateLoanFeePayment(userDetails.getUsername(), phoneNumber);

        return ResponseEntity.ok(new ApiResponse<>(true, "STK Push Initiated", response));
    }
